...
(function () {
  ...
  // Old way of doing manual dependency injection
  app.controller('AppCtrl', ['$scope', '$rootScope', function ($scope, $rootScope) {
    ...
    // Every scope has a unique $id property
    // Access the $id for the $rootScope
    console.log('$rootScope.$id: ' + $rootScope.$id);

    // Access the $id for the current scope
    console.log('$scope.$id: ' + $scope.$id);

    // Access the $id for the parent scope
